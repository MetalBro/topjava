...
//            new Meal(null, 6,LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510),
//            new Meal(null, 4,LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510)
    );
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    private static MealWithExceed createWithExceed(Meal meal, boolean exceeded) {
        return new MealWithExceed(meal.getUserId(), meal.getId(), meal.getDateTime(), meal.getDescription(), meal.getCalories(), exceeded);
    }
